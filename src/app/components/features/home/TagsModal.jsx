...
export default function TagsModal({ newTag, setNewTag, onAddTag, onClose, theme }) {
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            <div className={`${getBg(theme)} border-2 border-yellow-400 rounded-2xl shadow-lg p-6 w-[90%] max-w-md`}>
                <h2 className="text-center text-lg font-semibold mb-4 light:text-black">Adicione uma tag</h2>
                <Input
                    id="tag"
                    type="text"
                    value={newTag}
