                ...
                <div className="flex-1 pr-6">
                    ...
                    <div className="flex flex-wrap gap-3 mb-6">
                        <Button
                            ...
                            className="bg-[#FDC43A] hover:bg-yellow-400 text-white px-4 py-2 rounded-full font-medium"
                        >
                            + Adicionar Tag
                        </Button>
                            ...
                            <div className="bg-white rounded-2xl shadow-lg p-6 w-[90%] max-w-md border-2 border-[#2549BE]">
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="flex gap-2 flex-wrap">
                                        <button
                                            onClick={() =>
                                                setFiltros({ ...filtros, status: 'concluido' })
                                            }
                                            className={`px-3 py-1 rounded ${filtros.status === 'concluido' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}
                                        >
                                            Concluído
                                        </button>
                                        <button
                                            onClick={() =>
                                                setFiltros({ ...filtros, status: 'naoConcluido' })
                                            }
                                            className={`px-3 py-1 rounded ${filtros.status === 'naoConcluido' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}
                                        >
                                            Não concluído
                                        </button>
                                    </div>
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="flex gap-2 flex-wrap">
                                        <button
                                            onClick={() =>
                                                setFiltros({ ...filtros, ordem: 'alfabetica' })
                                            }
                                            className={`px-3 py-1 rounded ${filtros.ordem === 'alfabetica' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}
                                        >
                                            Alfabética
                                        </button>
                                        <button
                                            onClick={() =>
                                                setFiltros({ ...filtros, ordem: 'duracao' })
                                            }
                                            className={`px-3 py-1 rounded ${filtros.ordem === 'duracao' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}
                                        >
                                            Duração
                                        </button>
                                    </div>
                                    ...
                                    <div className="flex gap-2 flex-wrap">
                                        {['Diário', 'Semanal', 'Mensal', 'Anual'].map((f) => (
                                            <button
                                                key={f}
                                                onClick={() =>
                                                    setFiltros({ ...filtros, frequencia: f })
                                                }
                                                className={`px-3 py-1 rounded ${filtros.frequencia === f ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}
                                            >
                                                {f}
                                            </button>
                                        ))}
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-6 w-[90%] max-w-md border-2 border-[#2549BE]">
                        ...
                        <div className="mb-3">
                            ...
                            <select
                                ...
                                onChange={(e) =>
                                    setNewHabit({ ...newHabit, frequencia: e.target.value })
                                }
                            >
                        ...
                        <div className="mb-3">
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setNewHabit({ ...newHabit, descricao: e.target.value })
                                }
                            />
                        </div>
