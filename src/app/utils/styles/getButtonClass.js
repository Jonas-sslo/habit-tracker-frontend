export function getButtonClass({ color = 'primary', variant = 'solid', size = 'md', disabled = false }) {
  const base =
    'font-medium rounded-full shadow-sm transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#2549BE]';
  ...
  const colors = {
    primary: {
      ...
      disabled: 'bg-[#2549BE] text-white opacity-50 cursor-not-allowed dark:bg-[#1E40AF] dark:text-gray-400',
    },
    secondary: {
      ...
      disabled: 'bg-[#77CBB9] text-white opacity-50 cursor-not-allowed dark:bg-[#276749] dark:text-gray-400',
    },
    danger: {
      ...
      disabled: 'bg-[#96031A] text-white opacity-50 cursor-not-allowed dark:bg-[#742A2A] dark:text-gray-400',
    },
    white: {
      ...
      disabled: 'bg-white text-black opacity-50 cursor-not-allowed dark:bg-gray-700 dark:text-gray-400',
    },
    gray: {
      solid:
     ...
     black: {
      ...
      disabled: 'bg-[#111827] text-white opacity-50 cursor-not-allowed dark:bg-[#1F2937] dark:text-gray-400',
    },
    yellow: {
